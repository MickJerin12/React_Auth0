...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Dosáhl jste limitu pro počet pokusů o změnu hesla. Prosím počkejte před dalším pokusem.',
      'lock.fallback': 'Je nám líto, ale něco se pokazilo při změně hesla.',
      enterprise_email: 'Doména vašeho e-mailu je součástí poskytovatele podnikové identity. Chcete-li obnovit heslo, obraťte se na správce zabezpečení.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Je požadováno vícefaktorové ověření, ale zařízení není registrováno. Prosím registrujte jej, než budete pokračovat.',
  ...
  forgotPasswordInstructions: 'Prosím zadejte emailovou adresu. Pošleme vám email, díky němuž si budete moci změnit heslo.',
  ...
  passwordlessEmailAlternativeInstructions: 'Případně zadejte email pro přihlášení <br/>nebo vytvoření účtu',
  ...
  signUpTerms: 'Tím, že se zaregistrujete, souhlasíte s našimi smluvními podmínkami a zásadami ochrany osobních údajů.'
};
